...
def test_config_load_cat_annual_stockrow(
    ...
    stmts = FinancialStatements(
        annual_stockrow_income_stmt_cat,
        annual_stockrow_bs_stmt_cat,
        auto_adjust_config=False,
    )
...
def test_config_load_cat_annual_capiq(
    ...
    stmts = FinancialStatements(
        annual_capiq_income_stmt, annual_capiq_bs_stmt[dates], auto_adjust_config=False
    )
