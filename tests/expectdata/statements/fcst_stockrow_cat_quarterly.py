...
FCST_STOCKROW_CAT_Q_INDEX_DATA_DICT = dict(
    ...
    rd_exp=pd.Series(
        [556710471.3392289, 476761184.98755884], index=FCST_STOCKROW_CAT_Q_INDEX
    ),
    sga=pd.Series(
    ...
    op_exp=pd.Series(
        [1816614515.1807182, 1745632647.5680046], index=FCST_STOCKROW_CAT_Q_INDEX
    ),
    ebit=pd.Series(
        [2057758425.9069111, 2192284139.3089275], index=FCST_STOCKROW_CAT_Q_INDEX
    ),
    int_exp=pd.Series(
        [117698628.55091405, 118235016.7584711], index=FCST_STOCKROW_CAT_Q_INDEX
    ),
    ...
    ebt=pd.Series(
        [1940059797.355997, 2074049122.5504565], index=FCST_STOCKROW_CAT_Q_INDEX
    ),
    tax_exp=pd.Series(
        [592739424.3895106, 633676696.3222319], index=FCST_STOCKROW_CAT_Q_INDEX
    ),
    net_income=pd.Series(
        [1347320372.9664865, 1440372426.2282248], index=FCST_STOCKROW_CAT_Q_INDEX
    ),
    cash=pd.Series(
    ...
    gross_ppe=pd.Series([12853612568.208256, 0.0], index=FCST_STOCKROW_CAT_Q_INDEX),
    dep=pd.Series([0.0, 12865235637.252861], index=FCST_STOCKROW_CAT_Q_INDEX),
    net_ppe=pd.Series(
    ...
    st_debt=pd.Series(
        [12389396735.328041, 12461220850.21362], index=FCST_STOCKROW_CAT_Q_INDEX
    ),
    ...
    total_current_liab=pd.Series(
        [19152335949.560028, 19333348482.049824], index=FCST_STOCKROW_CAT_Q_INDEX
    ),
    lt_debt=pd.Series(
        [25689310937.859745, 25791022997.578564], index=FCST_STOCKROW_CAT_Q_INDEX
    ),
    ...
    total_non_current_liab=pd.Series(
        [27528585937.859745, 27630297997.578564], index=FCST_STOCKROW_CAT_Q_INDEX
    ),
    total_liab=pd.Series(
        [46680921887.41977, 46963646479.62839], index=FCST_STOCKROW_CAT_Q_INDEX
    ),
