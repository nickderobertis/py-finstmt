...
FCST_STOCKROW_MAR_A_INDEX_DATA_DICT = dict(
    ...
    cogs=pd.Series(
        [16173270221.707315, 16774265514.320614], index=FCST_STOCKROW_MAR_A_INDEX
    ),
    gross_profit=pd.Series(
        [4083196444.9593563, 4539504182.64909], index=FCST_STOCKROW_MAR_A_INDEX
    ),
    ...
    ebit=pd.Series(
        [3247863111.626023, 3686273879.618787], index=FCST_STOCKROW_MAR_A_INDEX
    ),
    ...
    tax_exp=pd.Series(
        [995951943.821048, 1130389893.1950514], index=FCST_STOCKROW_MAR_A_INDEX
    ),
    net_income=pd.Series(
        [2251911167.804975, 2555883986.4237356], index=FCST_STOCKROW_MAR_A_INDEX
    ),
    ...
    total_current_assets=pd.Series(
        [8608270927.216713, 11879872619.231655], index=FCST_STOCKROW_MAR_A_INDEX
    ),
    gross_ppe=pd.Series([2028093740.9345036, 0.0], index=FCST_STOCKROW_MAR_A_INDEX),
    dep=pd.Series([0.0, 2102844694.2830825], index=FCST_STOCKROW_MAR_A_INDEX),
    net_ppe=pd.Series(
    ...
    total_assets=pd.Series(
        [29517397489.16806, 32840357008.766415], index=FCST_STOCKROW_MAR_A_INDEX
    ),
    payables=pd.Series(
    ...
    current_lt_debt=pd.Series(
        [776110714.178354, 887214695.3089366], index=FCST_STOCKROW_MAR_A_INDEX
    ),
    ...
    total_current_liab=pd.Series(
        [4016549687.392251, 4314619811.944415], index=FCST_STOCKROW_MAR_A_INDEX
    ),
    lt_debt=pd.Series(
        [9732820044.698414, 11126120040.225893], index=FCST_STOCKROW_MAR_A_INDEX
    ),
    ...
    total_non_current_liab=pd.Series(
        [15506613996.151344, 17411319247.208252], index=FCST_STOCKROW_MAR_A_INDEX
    ),
    total_liab=pd.Series(
        [19523163683.543594, 21725939059.152668], index=FCST_STOCKROW_MAR_A_INDEX
    ),
    ...
    total_liab_and_equity=pd.Series(
        [29517397489.168064, 32840357008.766422], index=FCST_STOCKROW_MAR_A_INDEX
    ),
)
