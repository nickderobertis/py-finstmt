...
FCST_STOCKROW_CAT_NO_BALANCE_A_INDEX_DATA_DICT = dict(
	...
	int_exp=pd.Series(
		[465174147.1845379, 471960192.1639289],
		index=FCST_STOCKROW_CAT_A_INDEX
	),
	...
	tax_exp=pd.Series(
		[3308120524.0305653, 3745941388.103728],
		index=FCST_STOCKROW_CAT_A_INDEX
	),
	net_income=pd.Series(
		[5603013480.772726, 6344557262.429344],
		index=FCST_STOCKROW_CAT_A_INDEX
	),
	cash=pd.Series(
	...
	total_assets=pd.Series(
		[67914358212.014595, 70930481782.96048],
		index=FCST_STOCKROW_CAT_A_INDEX
	),
	payables=pd.Series(
	...
	st_debt=pd.Series(
		[11746812154.417816, 11943913393.304644],
		index=FCST_STOCKROW_CAT_A_INDEX
	),
	...
	total_current_liab=pd.Series(
		[19251738374.252876, 19962448400.70801],
		index=FCST_STOCKROW_CAT_A_INDEX
	),
	lt_debt=pd.Series(
	...
	total_debt=pd.Series(
		[37086124720.65068, 37627143846.47451],
		index=FCST_STOCKROW_CAT_A_INDEX
	),
	...
	total_liab=pd.Series(
		[46312250940.48574, 47366878853.877884],
		index=FCST_STOCKROW_CAT_A_INDEX
	),
	...
	total_liab_and_equity=pd.Series(
		[76882984273.81909, 78802763702.36275],
		index=FCST_STOCKROW_CAT_A_INDEX
	),
)
