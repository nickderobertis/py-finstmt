...
FCST_CAPIQ_CAT_A_INDEX_DATA_DICT = dict(
    ...
    rd_exp=pd.Series(
        [1660.4438910340386, 1348.959364124922], index=FCST_CAPIQ_CAT_A_INDEX
    ),
    ...
    op_exp=pd.Series(
        [6325.641009436247, 5829.640231743842], index=FCST_CAPIQ_CAT_A_INDEX
    ),
    ebit=pd.Series(
        [12045.487476364575, 13326.014740864432], index=FCST_CAPIQ_CAT_A_INDEX
    ),
    int_exp=pd.Series(
        [94.76554690770675, 90.68363007665323], index=FCST_CAPIQ_CAT_A_INDEX
    ),
    ...
    ebt=pd.Series(
        [11950.721929456868, 13235.33111078778], index=FCST_CAPIQ_CAT_A_INDEX
    ),
    tax_exp=pd.Series(
        [7075.201613802817, 7835.730476118288], index=FCST_CAPIQ_CAT_A_INDEX
    ),
    net_income=pd.Series(
        [4875.520315654051, 5399.600634669492], index=FCST_CAPIQ_CAT_A_INDEX
    ),
    cash=pd.Series(
        [10459.99567259742, 10742.598041900244], index=FCST_CAPIQ_CAT_A_INDEX
    ),
    ...
    total_current_assets=pd.Series(
        [30790.77087620282, 31001.925478313005], index=FCST_CAPIQ_CAT_A_INDEX
    ),
    ...
    total_assets=pd.Series(
        [54821.62668180307, 55053.13219981306], index=FCST_CAPIQ_CAT_A_INDEX
    ),
    payables=pd.Series(
    ...
    current_lt_debt=pd.Series(
        [58.95668581440481, 56.41719444879981], index=FCST_CAPIQ_CAT_A_INDEX
    ),
    ...
    total_current_liab=pd.Series(
        [11314.2911657651, 11612.0550819469], index=FCST_CAPIQ_CAT_A_INDEX
    ),
    lt_debt=pd.Series(
        [7223.835516037975, 6912.67711786616], index=FCST_CAPIQ_CAT_A_INDEX
    ),
    ...
    total_non_current_liab=pd.Series(
        [10542.635516037975, 10231.477117866161], index=FCST_CAPIQ_CAT_A_INDEX
    ),
    total_liab=pd.Series(
        [21856.926681803074, 21843.53219981306], index=FCST_CAPIQ_CAT_A_INDEX
    ),
    common_stock=pd.Series([5983.3, 6181.000000000001], index=FCST_CAPIQ_CAT_A_INDEX),
    other_income=pd.Series(
        [424.90000000000146, 1458.6000000000022], index=FCST_CAPIQ_CAT_A_INDEX
    ),
    retained_earnings=pd.Series(
        [26488.1, 25501.600000000002], index=FCST_CAPIQ_CAT_A_INDEX
    ),
    minority_interest=pd.Series([68.4, 68.4], index=FCST_CAPIQ_CAT_A_INDEX),
    total_equity=pd.Series([32964.7, 33209.600000000006], index=FCST_CAPIQ_CAT_A_INDEX),
    total_liab_and_equity=pd.Series(
        [54821.62668180307, 55053.132199813066], index=FCST_CAPIQ_CAT_A_INDEX
    ),
)
