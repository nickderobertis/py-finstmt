...
FCST_STOCKROW_MAR_Q_INDEX_DATA_DICT = dict(
	...
	tax_exp=pd.Series(
		[240919799.67078555, 247747562.20363835],
		index=FCST_STOCKROW_MAR_Q_INDEX
	),
	net_income=pd.Series(
		[519823673.30253744, 534555682.06692696],
		index=FCST_STOCKROW_MAR_Q_INDEX
	),
	cash=pd.Series(
	...
	total_current_assets=pd.Series(
		[2557543965.2324142, 6655719520.035959],
		index=FCST_STOCKROW_MAR_Q_INDEX
	),
	gross_ppe=pd.Series(
		[0.0, 0.0],
	...
	current_lt_debt=pd.Series(
		[992388829.6683247, 573730286.8627206],
		index=FCST_STOCKROW_MAR_Q_INDEX
	),
	...
	total_current_liab=pd.Series(
		[3915604862.0400667, 3533886596.239655],
		index=FCST_STOCKROW_MAR_Q_INDEX
	),
	lt_debt=pd.Series(
	...
	total_liab_and_equity=pd.Series(
		[31468727032.664803, 26484191954.03825],
		index=FCST_STOCKROW_MAR_Q_INDEX
	),
)
