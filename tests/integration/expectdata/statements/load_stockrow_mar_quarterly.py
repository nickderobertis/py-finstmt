...
LOAD_STOCKROW_MAR_Q_INDEX = [
    pd.to_datetime(val) for val in LOAD_STOCKROW_MAR_Q_INDEX_str
]
LOAD_STOCKROW_MAR_Q_INDEX_DATA_DICT = dict(
    revenue=pd.Series(
        [
            3380000000.0,
            2630000000.0,
        ...
        index=LOAD_STOCKROW_MAR_Q_INDEX,
    ),
    cogs=pd.Series(
        [
            2943000000.0,
